...
"SELECT projects.category, pledges.amount FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.category, pledges.amount HAVING projects.category = 'music';"
end
